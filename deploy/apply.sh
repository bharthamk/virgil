...
echo
echo "the runtime identity may read learner boards and call Vertex Gemini"
...
# ID token before selecting a learner board.

echo
echo "next: ./deploy/schedule.sh, then the gate the architecture actually sets —"
