...
The [detailed implementation map](docs/architecture.png) expands the service,
...
service and state. The [Google backend engineering map](docs/GOOGLE_BACKEND.md)
...
[operations and recovery runbook](docs/OPERATIONS.md) owns monitoring,
...
are in the [public release receipt](docs/RELEASE.md).
...
[current release receipt](docs/RELEASE.md) names the exact current revision and
