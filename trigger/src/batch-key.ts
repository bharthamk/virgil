 ...
 * and the batch-idempotency contract’s per-night key stops protecting anything — the store would be
...
/**
 * The store id a night's session is written under (the batch-idempotency contract).
 *
 * **Cross-lane contract.** The batch-idempotency contract’s *write* side belongs to the Firestore
