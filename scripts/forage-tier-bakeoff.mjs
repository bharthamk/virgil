 ...
 * stays on, latency is free at 3am"*, and **the event-driven processing contract removed 3am**. There is
...
const OUT = arg('out', 'artifacts/forage-tier');
/**
 ...
 * are free — but a TIER RULING for the shipped product has to be measured on
