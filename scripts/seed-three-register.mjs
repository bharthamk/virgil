/**
 * Layer the register-evidence distinction's signal ledger onto an already-clustered board, and age the
...
// The seed-clustering realism constraint: same-page pins share a verbatim heading prefix and cluster
