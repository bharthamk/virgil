...
const lanes = [
  ...
  // `panel.ts` is mounted through isolated DOM workers and reports a 19% V8
  // aggregate despite the extension's 1,900+ behavioural tests. This is an
  // honest floor, not a target; room extraction and browser acceptance are how
  // it rises without counting removed documentation as executable coverage.
  { name: 'extension', lines: 19, branches: 30, functions: 18, heap: 6_144 },
