 ...
 *
 * `three-register` is decision-sheet item 8: the same 21 pins, the same six
 ...
 * one such reason in the product, and it is not a tuning knob:
...
/**
 * Decision-sheet item 8. Same corpus, same nine pin clusters, same six weeks.
