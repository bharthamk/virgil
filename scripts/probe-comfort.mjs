 ...
 *
 * The reason it exists: SB-25's claim is that three registers appear in one
 ...
 *   node scripts/probe-comfort.mjs --table three-register   # the register-evidence distinction's ledger
