/**
 * The declared content script for the re-read detector.
 *
 ...
 * across the boundary, and can hold no imports at all (reviewer-boundary constraint). The detector is the
