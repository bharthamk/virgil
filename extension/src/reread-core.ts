/**
 * The re-read state machine, with the DOM taken out of it (SB-15).
 *
...
/**
 * How many rejections it takes to stop raising on a site (SB-16).
 *
...
export interface TrackerOptions {
  /**
   * SB-16: the learner has turned this site down enough times. Counting carries
 ...
 * raised, never pinned: the learner confirms it (SB-15).
 */
 ...
 * inside a body of knowledge (SB-06).
 *
