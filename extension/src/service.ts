...
/**
 * The one way this extension talks to the service — the exposed-service authentication boundary.
 *
...
export async function serviceHeadersFor(
  ...
  /**
   * And who is asking — the Firebase identity boundary.
   *
...
/** Queue replay supplies the token from the same snapshot used to check ownership. */
