 ...
 *
 * the confirmation copy reflects the pin type immediately, or the user
 * will not believe the two types are treated differently. : when the
...
/**
 * the image is the bytes, or it is nothing at all.
 *
...
/**
 *  — the one capture the product refuses, and what it says instead.
 *
 ...
 *
 * Deliberately narrow. A thin HTML page is a legitimate whole-page pin
...
/**
 *  — the escalation, and the one condition on offering it.
 *
 ...
 * about, with a comfort signal attached to it.  protects capture from the
 ...
 * in it, which the copy read as offline and answered with  promise to
