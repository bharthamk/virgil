/**
 *  — THE CLOSE ON A QUICK TAKE, AND WHY THE ROOM HAS ONE AT ALL.
 *
 ...
 * missing. *Got it* and *Still fuzzy* are the two readings  built. *Not
 ...
 *  4. ** exclusion stands.** None of the three is in
