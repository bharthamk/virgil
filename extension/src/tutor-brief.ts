 ...
 *
 * Both facts are already chips on the lesson ( the interface-affordance contract). Null for neither is
 ...
 *
 * The house law is that the affordances are the instruction ( the interface-affordance contract), and
