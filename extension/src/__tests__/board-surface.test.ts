...
test('a card never carries a comfort number, and never a score', () => {
  ...
  // SB-33: comfort is never shown as a number. The state is a word.
...
test('a topic in an area this build does not know about is still on the board', () => {
  // It used to fall out of every group and vanish from the learner's own board.
 ...
 *
 * SB-33 says topics are the display unit and pins are the evidence unit, and
