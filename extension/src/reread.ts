/**
 * Re-read detection — the one agent-initiated capture signal (SB-15).
 *
...
export interface DetectorOptions {
  /** SB-16: this site has been told no twice. Do not raise here. */
...
export function startRereadDetector(
  ...
  // SB-16, the load-bearing half: quieted means nothing is observed at all, not
