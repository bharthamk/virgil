 ...
 *
 *   1. as asked
 *   2. same, with double the headroom — fixes plain truncation, which is D10:
 ...
 * provider. A port costs an adapter, not a rewrite; the same rule applies to
 * the adapters themselves.
 */

/** The budget an unstated request gets; a too-small budget is reported as truncation. */
