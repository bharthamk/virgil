...
/**
 * deletion must propagate into derived state. This is the test that
 ...
 * names anything.  says deletion must reach derived state; these are the
...
test('the pin cascade and a confirmed topic deletion agree', async () => {
  // The contract stated as a test: reaching an empty topic one pin at a time and
