...
test('SB-55: the evidence behind a statement survives the store round-trip', async () => {
  const s = store();
...
test('SB-55: regeneration replaces the derived read and leaves an edited line alone', async () => {
