 ...
 * nothing and reads no record, and a registry that omitted it made the documentation
 ...
 * sixteenth agent in the documentation.
 *
 * Kept as a named constant so the framework tree, tests, and architecture
 * diagram share one agent count.
 */
