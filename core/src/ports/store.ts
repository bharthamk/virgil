 ...
 *
 *  is the reason `deletePin` and `deleteTopic` are on this interface
 ...
 * clustering-stability constraint was fought to prevent.
 */
export interface Store {
  ...
  /** Cascades to member pins on explicit confirmation (). */
  ...
  // signals — append-only; history is what makes regression detectable
  ...
  /** full wipe, one confirmed action. */
