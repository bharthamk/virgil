 ...
 *
 * The Reviewer (SB-38) reads a draft against what the learner is shaky on. This
 ...
 *     soften it.
 *
 * Like the Reviewer, this agent says what is wrong and never writes the fix.
 * The schema has nowhere for a
