 ...
 *
 * Attach-only clustering (clustering-stability constraint) made the board stable by making an
 ...
 *
 * A new topic with no evidence is safe to create precisely because safe-empty-state constraint was
...
export function planMerge(
  ...
  return {
    keep: {
      ...
      // material that was taught. Taking the later of the two keeps safe-empty-state constraint honest
