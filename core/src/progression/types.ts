 ...
 *
 * What is deliberately absent, and must stay absent : any count of
...
/**
 *  — a comfort-ledger register transition, stated as a fact.
 *
...
/**
 *  — a per-topic run of demonstrated recalls across expanding intervals.
 *
 ...
 * quantity the product contract bans.
 */
export interface Chain extends AboutATopic {
   ...
   *    next recall is owed sooner. : no zero is ever displayed as a
