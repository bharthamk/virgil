...
/**
 *  — a chain that pauses instead of breaking.
 *
 ...
 * signals, and nothing that returns a sum. the product contract bans the global chain, and
 ...
 *
 *  walkthrough is the source: *day 2, day 5, day 12 — a chain of three,
