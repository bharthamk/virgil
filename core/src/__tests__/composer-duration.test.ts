...
/**
 * Duration used to be whatever the model claimed, and it claimed exactly the
 * budget on three consecutive runs — targeting the number, not estimating. It
 * is now computed from what was actually written.
 */
...
test('registerFor refuses a confident register on thin evidence', () => {
  // SB-52: comfort and certainty are different questions. High comfort on two
