...
/**
 * The clusterer after clustering-stability constraint: the model no longer decides what goes
...
test('a wired coarse space is used by default — D1 is the default rule, not an opt-in', async () => {
  // The flip. Before the partition-strategy contract was ruled this same wiring produced `single`
