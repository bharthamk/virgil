...
/**
 * clustering-stability constraint: the same 21 pins, the same prompt, the same model, three
...
test('every pin lands in exactly one topic', () => {
  ...
  // construction, silently, and that is exactly how partition-invariant constraint happened.
