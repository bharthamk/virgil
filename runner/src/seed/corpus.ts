 ...
 * six different sites, over six weeks, is (SB-19).
 *
 ...
 * SB-46 still exercises capture-envelope fallback. Every selection and context
...
export const SEED_PINS: readonly SeedPin[] = [
  ...
  // ---- Ordering keys: advanced, pinned BEFORE the basics were solid (tests SB-21)
  ...
  // ---- Tritone substitution: struggle that DEPENDS on seventh chords (SB-21)
