 ...
 * authentication bypass in a deployed estate. The Firebase identity boundary builds against the
...
test('the emulator off Cloud Run is exactly how the Firebase identity boundary says to build', () => {
  const choice = identityChoice('firebase:virgil-506009@127.0.0.1:9099');
