 ...
 *
 * The pipeline is stage-by-stage failure-tolerant by design (graceful-degradation constraint), and every
...
test('a failed analyse takes the statement stage down with it, and the line says so honestly', async () => {
  ...
  // A prefix rather than the whole line:  appends what the modality
