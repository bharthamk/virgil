...
/**
 * **The exposed-service authentication boundary: an exposed single-board service carries an operator secret.**
 *
 * The Firebase identity boundary supersedes this as the production learner route: that service
